...
import "./MyToken6464F3D1.sol";

contract MyToken6464F3D1PreSale {
    MyToken6464F3D1 public token;
    ...
    function MyToken6464F3D1PreSale(
        MyToken6464F3D1 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken6464F3D1(_token);
